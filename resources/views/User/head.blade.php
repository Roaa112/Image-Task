...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('User/assets')}}/vendors/jvectormap/jquery-jvectormap.css">
    <link rel="stylesheet" href="{{asset('User/assets')}}/vendors/flag-icon-css/css/flag-icon.min.css">
    <link rel="stylesheet" href="{{asset('User/assets')}}/vendors/owl-carousel-2/owl.carousel.min.css">
    <link rel="stylesheet" href="{{asset('User/assets')}}/vendors/owl-carousel-2/owl.theme.default.min.css">
